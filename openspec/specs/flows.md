...
| `DomainCandidate` | `packages/domain` | `origin: github`, `bucket: unpublished_draft` |
| `repository` | `packages/repository` | `ownerUserId`, `githubFullName`, `status`, `statusUpdatedAt`, `githubSyncedAt` |
